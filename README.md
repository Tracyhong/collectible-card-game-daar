...
Welcome to the DAAR project, developed by Tracy HONG and Laura RATTANAVAN.

The idea will be to implement a Collectible Card Game
...
Get your own private api key here : https://dev.pokemontcg.io/

Create a .env file in the backend directory and write :
```env 
PORT=3000
POKEMON_TCG_API_KEY = your_private_key
```
